...
public class OutreachVfsFeedbackApplication {

	public static void main(String[] args) {
		SpringApplication.run(OutreachVfsFeedbackApplication.class, args);
	}
...
//	    return new Docket(DocumentationType.SWAGGER_2)          
//	      .select()
//	      .apis(RequestHandlerSelectors.basePackage("com.cognizant.outreach.vfs"))
...
//	}
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("VFS Feedback REST API Documentation")
