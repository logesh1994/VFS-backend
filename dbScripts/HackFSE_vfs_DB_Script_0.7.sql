...
CREATE TABLE IF NOT EXISTS `outreach_vfs`.`event` (
  ...
  `total_volunteer_hrs` FLOAT(11) NOT NULL,
  `total_travel_hrs` FLOAT(11) NOT NULL,
  `overall_volunteer_hrs` FLOAT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `outreach_vfs`.`event_details` (
  ...
  `employee_id` INT(11) NOT NULL,
  `volunteer_hrs` FLOAT(11) NOT NULL,
  `travel_hrs` FLOAT(11) NOT NULL,
